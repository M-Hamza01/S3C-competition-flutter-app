...
"@
    ...
    "lib/shared/models/api_response.dart" = "// Generic ApiResponse<T> wrapper"
    ...
    "lib/features/scan/presentation/screens/my_qr_screen.dart" = "// Student's own QR via qr_flutter; works offline"
    ...
    "lib/features/services/presentation/screens/services_screen.dart" = "// S³C home: category tiles + active requests"
    ...
    "lib/features/services/presentation/widgets/category_tile.dart" = "// Coloured icon tile for each S³C category"
